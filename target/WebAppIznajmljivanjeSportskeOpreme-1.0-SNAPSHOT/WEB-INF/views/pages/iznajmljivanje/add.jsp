<%-- 
    Document   : add
    Created on : Jun 23, 2019, 1:41:39 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>    
        ...
        <div class="container">
            <form:form method="POST" action="/WebAppIznajmljivanjeSportskeOpreme/iznajmljivanje/save" modelAttribute="izn" class="formAdd">
                <h2 class="text-center h2">Popunite podatke o iznajmljivanju</h2>
                <div class="form-group">
                    <form:label path="oprema">Oprema</form:label>
                    <form:input path="oprema.id" class="inputField" readonly="true" value="${izn.oprema.id}"/> 
                </div>
                <c:if test="${tip == 'radnik'}">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <form:input path="radnik.id" class="inputField" readonly="true" value="${izn.radnik.id}"/> 
                    </div>
                </c:if>
                <c:if test="${tip == 'klijent'}">
                    <div class="form-group">
                        <form:label path="klijent">Klijent</form:label>
                        <form:input path="klijent.id" class="inputField" readonly="true" value="${izn.klijent.id}"/> 
                    </div>
                </c:if>
                <div class="form-group">
